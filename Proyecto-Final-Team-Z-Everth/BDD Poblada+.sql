...
INSERT INTO EJEMPLAR (id, nombre, Palabras_claves, fecha_publicacion, id_coleccion, id_editorial, id_idioma, id_formato, etiqueta)
    VALUES  (1, 'DIARIO DE GREG 16. EL NUMERO 1', 'DIARIO, GREG', CONVERT(DATE,'26/10/2021',103),1,1,1,1,'9788427216907'),
            (2, 'DIARIO DE GREG 15. TOCADO Y HUNDIDO', 'DIARIO, GREG', CONVERT(DATE,'27/10/2020',103) ,1,1,1,1,'9788427221239'),
            (3, 'DIARIO DE GREG 13. FRIO FATAL', 'DIARIO, GREG',  CONVERT(DATE,'30/10/2018',103),1,1,1,1,'9788427213128'),
            (4, 'CARRETERA MALDITA', 'CARRETERA, MALDITA', CONVERT(DATE,'7/3/1981',103),2,3,1,1,'9788497596541'),
            (5,'YO ANTES DE TI',' YO, ANTES, TI',CONVERT(DATE,'5/1/2015',103),4,3,1,1,'9788483655931'),
            (6, 'BELLAS DURMIENTES','BELLAS DURMIENTES, DURMIENTES, BELLAS', CONVERT(DATE,'26/9/2017',103),2,3,1,1,'9788466346528'),
            (7,'FIN DE GUARDIA','GUARDIA',CONVERT(DATE,'7/6/2016',103),2,3,1,1,'9788466345454'),
            (8, 'A BRIEF HISTORY OF TIME','BRIEF, HISTORY, TIME',CONVERT(DATE,'2/4/1988',103),3,4,1,1,'978055280136'),
            (9,'LA ZONA MUERTA','LA, ZONA, MUERTA',CONVERT(DATE,'1/8/1979',103),2,3,1,1,'9788466357135'),
            ...
            (37,'WIGETTA Y EL BACULO DORADA','WIGETTA, BACULO, DORADO,',CONVERT(DATE,'9/2/2016',103),14,14,1,1,'9786070731556'),
            (38,'WIGETTA EN EL PLANETA MIMISIKÚ ', 'VEGETA, WILLY, PLANETA, MIMISIKÚ, WIGETTA',CONVERT(DATE, '15/3/2017',103),14,14,1,1,'9786070740169'),
            (39,'WIGETTA Y LA ISLA DE MUMUCHUMU','WIGETTA,ISLA,DE,MUMUCHUMU',CONVERT(DATE,'18/12/2018',103),14,14,1,1,'9786070754692'),
            ...
            (43,'DON QUIJOTE DE LA MANCHA','DON, QUIJOTE, MANCHA', CONVERT(DATE,'5/3/1605',103),16,19,1,1,'9788497943697'),
            ...
            (61,'GRAN GATSBY','GRAN, GATSBY',CONVERT(DATE,'10/4/1925',103),16,10,1,1,'9788418395185'),
            (62,'WIGETTA Y LA FERIA FANTASMA ', 'VEGETA, WILLY, FERIA, FANTASMA WIGETTA',CONVERT(DATE, '4/7/2017',103),14,14,1,1,'9786070742095'),
            (63,'LA DIVINA COMEDIA','DIVINA, COMEDIA',CONVERT(DATE,'3/6/1960',103),15,16,1,1,'978971093700'),
            (64,'WIGETTA Y EL ANTIDOTO SECRETO','WIGETTA, ANTIDOTO SECRETO',CONVERT(DATE,'31/05/2016',103),14,14,1,1,'9786070733338'),
            (65,'EL PRINCIPITO','PRINCIPITO',CONVERT(DATE,'6/4/1943',103),16,5,1,1,'9788418174193'),
            (66,'DRACULA','DRACULA',CONVERT(DATE,'26/5/1897',103),16,17,1,1,'9780593203385'),
            (67, 'WIGETTA Y EL CUENTO JAMAS CONTADO ', 'VEGETA, WILLY, CUENTO, JAMAS, CONTADO, WIGETTA',CONVERT(DATE, '23/10/2018',103),14,14,1,1,'9786070745607'),
            (68,'WIGETTA Y EL BACULO DORADA','WIGETTA, BACULO, DORADO,',CONVERT(DATE,'9/2/2016',103),14,14,1,1,'9786070731556'),
            (69,'WIGETTA EN EL PLANETA MIMISIKÚ ', 'VEGETA, WILLY, PLANETA, MIMISIKÚ, WIGETTA',CONVERT(DATE, '15/3/2017',103),14,14,1,1,'9786070740169'),
            (70,'WIGETTA Y LA ISLA DE MUMUCHUMU','WIGETTA,ISLA,DE,MUMUCHUMU',CONVERT(DATE,'18/12/2018',103),14,14,1,1,'9786070754692'),
            (71,'FRANKENSTEIN','FRANKENSTEIN',CONVERT(DATE, '1/1/1918',103),16,16,1,1,'9788418145155'),
            (72,'UNIVERSO WIGETTA 3 EL CORAZON OSCURO','WIGETTA,CORAZON,OSCURO,UNIVERSO',CONVERT(DATE,'24/11/2021',103),14,14,1,1,'9786070780967'),
            (73, 'WIGETTA Y EL TESORO DE CHOCATUSPALMAS ', 'VEGETA, WILLY, TESORO, CHOCATUSPALMAS, WIGETTA',CONVERT(DATE, '3/7/2018',103),14,14,1,1,'9786070751080'),
            (74,'DON QUIJOTE DE LA MANCHA','DON, QUIJOTE, MANCHA', CONVERT(DATE,'5/3/1605',103),16,19,1,1,'9788497943697'),
            (75,'MAZE RUNNER PRUEBA DE FUEGO','MAZE, RUNNER, PRUEBA, FUEGO',CONVERT(DATE,'18/9/2010',103),18,20,1,1,'9789876123549'),
            (76,'ADVENTURES OF TOM SAWYER', 'TOM, SAWYER, ADVENTURES, MISURI', CONVERT(DATE, '25/6/1876',103),16,17,2,1,'9780141321103'),
            (77,'MAZE RUNNER LA CURA MORTAL','MAZE, RUNNER, CURA, MORTAL',CONVERT(DATE,'11/10/2011',103),18,20,1,1,'9789876124232'),
            (78,'MAZE RUNNER CORRER O MORIR','MAZE,RUNNER,CORRER,MORIR',CONVERT(DATE,'6/10/2009',103),18,20,1,1,'9789876122672'),
            (79,'METAMORFOSIS','METAMORFOSIS',CONVERT(DATE,'1/1/1915',103),16,3,1,1,'9788467058758'),
            (80,'MUJERCITAS','MUJERCITAS',CONVERT(DATE, '30/7/1868',103),16,3,1,1,'9788491053910'),
            (81,'FANTASMA DE LA OPERA', 'FANTASMA, OPERA',CONVERT(DATE,'23/9/1909',103),16,21,1,1,'9788415979227'),
            (82,'HUNGER GAMES 2 CATCHING FIRE','HUNGER,GAMES,CATCHING,FIRE',CONVERT(DATE,'1/9/2009',103),19,22,2,1,'9780545586177'),
            (83,'ROMEO Y JULIETA','ROMEO, JULIETA',CONVERT(DATE,'29/1/1597',103),16,23,1,1,'9788420651408'),
            (84,'HAMLET','HAMLET',CONVERT(DATE,'1/1/1603',103),16,7,2,1,'9780141396507'),
            (85,'HUNGER GAMES 3 MOCKINGJAY', 'HUNGER GAMES, HUNGER, GAMES',CONVERT(DATE,'21/11/2014',103),19,22,2,1,'9780545663267'),
            (86,'1984','1984',CONVERT(DATE,'8/6/1949',103),20,3,1,1,'9789875669284'),
            (87,'ORGULLO Y PREJUCIO','ORGULLO, PREJUICIO',CONVERT(DATE,'28/01/1813',103),16,24,1,1,'9786079723958'),
            (88,'MOBY DICK','MOBY, DICK',CONVERT(DATE,'18/10/1851',103),16,7,1,1,'9788491054290'),
            (89,'MISERABLES','MISERABLES',CONVERT(DATE,'1/1/1862',103),16,13,1,1,'9786070769566'),
            (90,'ANTIGONA', 'ANTIGONA, MITOLOGIA, GRECIA',NULL,9,7,1,1,'9788491050780'),
            (91,'EL DIARIO DE ANNE FRANK','DIARIO, ANNE, FRANK',CONVERT(DATE,'25/6/1947',103),16,3,1,1,'9788466340564'),
            (92,'GRAN GATSBY','GRAN, GATSBY',CONVERT(DATE,'10/4/1925',103),16,10,1,1,'9788418395185');
