...
public class eventosDAO
{
    public static bool CrearNuevo(eventos e)
    {
        ...
        try
        {
            ...
            {
                string query =
                    "INSERT INTO EVENTO (imagen, titulo, cant_asistentes, fecha_inicio, fecha_final) VALUES" +
                    "(@imagen, @titulo, @cant_asistentes, @fecha_inicio, @fecha_final)";
        ...
        using (SqlConnection connection = new SqlConnection(cadena))
        {
            ...
            using (SqlDataReader reader = command.ExecuteReader())
            {
                ...
                { 
                    ...
                    evento.cant_asistentes = Convert.ToInt32(reader["nombre_autor"].ToString());
